...
def train(args):
    ...
    # prepare x and y
    x = df_train_val_test.iloc[:, :-1].values
    y_3class = df_train_val_test.label.values  # raw data with 3 classes
    y = y_3class.copy()
    ...
    # fit the best model
    rfc = SVC(n_estimators=rfc_random.best_params_['n_estimators'],
